...
- **Request command** - domyslnie `!sr`; po wpisaniu np. `!srt` domyslne `!sr` nadal dziala jako alias. Mozesz tez wpisac kilka komend rozdzielonych spacja albo przecinkiem.
